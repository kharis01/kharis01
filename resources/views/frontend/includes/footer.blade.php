      ...
      <div class="row justify-content-between">
        ...
        <div class="col-md-6">
          <div class="social-links mb-3 mb-lg-0 text-center text-md-end">
            <a href="https://github.com/kharis01" target="blank" class="github"><i class="bi bi-github"></i></a>
            <a href="https://www.youtube.com/channel/UCEvIpfxQxW36U5jFnb3QS_Q" target="blank" class="youtube"><i
                class="bi bi-youtube"></i></a>
            <a href="https://www.instagram.com/ghazwan_khariz/?next=%2Fexplore%2F&hl=id" target="blank"
              class="instagram"><i class="bi bi-instagram"></i></a>
            <a href="#" class="google-plus"><i class="bi bi-skype"></i></a>
            <a href="https://www.linkedin.com/in/khariz-ghazwan-914201257/" target="blank" class="linkedin"><i
